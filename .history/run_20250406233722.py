...
def quiz_game_2():
    ...
    questions = [

        {
            ...
            "question": "What is the capital city Japan ?",

            "options": ["a. Osaka", "b. Tokyo", "c. Kyoto", "d. Nara", "e. Sapporo"],
...

        {
            ...
            "question": "What is the capital city USA ?",

            "options": ["a. Washington D.C.", "b. Texas", "c. Florida", "d. New York", "e. Houston"],
...

        {
            ...
            "question": "What is the capital city India?",

            "options": ["a. Kalkuta", "b. Mumbay", "c. New Delhi", "d. Banglalore", "e.Pune"],
    ...
    for q in questions:
        ...
        user_answer = input("Your answer (a/Bb/C/D): ").strip().upper()

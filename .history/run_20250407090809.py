...
def quiz_game_two():
    ...
    The only diffrence is the questiones and the answers.
    """
    questions = {
...
def main():
    """
    The main part of the whole game. Connected to provide the score of the games together or as the separete games.
    It contains the menu and scoreboard of the games.
    Also with the option to ask the player if he wants to continue or exit the game.
    """
